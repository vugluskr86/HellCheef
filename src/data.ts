...
export const RECIPES: RecipeDef[] = [
  ...
  // Алхимия
  { id: 'r_souffle', name: 'Суфле из эссенции души', tier: 5, station: 'alchemy', skill: 'alchemy', time: 22, difficulty: 78, needs: [{ id: 'soul_essence', qty: 1 }, { id: 'demon_egg', qty: 2 }, { id: 'brim_sugar', qty: 1 }], target: { sweet: .7, umami: .4, bitter: .3 }, idealHeat: 160, heatBand: 20, flipEvery: 4, base: 460, tags: ['elegant', 'sweet', 'cursed'], heal: 60 },
  { id: 'r_ambrosia', name: 'Амброзия падшего', tier: 5, station: 'alchemy', skill: 'alchemy', time: 24, difficulty: 85, needs: [{ id: 'angel_feather', qty: 1 }, { id: 'blood_wine', qty: 1 }, { id: 'crystal_thyme', qty: 1 }], target: { sweet: .6, sour: .4, umami: .4 }, idealHeat: 150, heatBand: 18, flipEvery: 4, base: 520, tags: ['elegant', 'blessed'], heal: 80 },
];
